...
module.exports = {
  ...
  shouldAlert: function(callback) {
    // we only need last two, as it's either away/motion or motion/motion
    alarmLogsRef.endAt().limit(5).on("value", function(alarmLogs) {
      var logs = []
